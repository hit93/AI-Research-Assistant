...
# 2. Run all offline unit & mock tests (46 tests, ~9s)
uv run pytest tests/ -k "not test_arxiv_search and not test_web_search"

# 3. Run specific test modules
uv run pytest tests/test_graphs.py tests/test_agents.py tests/test_exporter.py -v

# 4. Run the full suite including live external APIs (48 tests)
uv run pytest tests/
```
...
├── pyproject.toml           # Modern Python build, dependency, and tool configs
